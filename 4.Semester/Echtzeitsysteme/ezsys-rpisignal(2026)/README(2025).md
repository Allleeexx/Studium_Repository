...
Für die Ansteuerung der GPIO-Pins wird die Bibliothek `libgpiod` (Version 2) verwendet. Die Initialisierung des Pins erfolgt bereits durch die bestehende Initialisierungsroutine. Ihre Aufgabe ist lediglich, den Pin auf 0 oder 1 zu setzen. Hierfür verwenden Sie folgenden Funktionsaufruf:
